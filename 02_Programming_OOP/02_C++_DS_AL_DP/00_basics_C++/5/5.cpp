...
//////////////////////////////////////////////////////////////////////////////////
// var less than 4 bytes can not be operated for arthimatic operations
	  short int var1 = 32767; // Maximum value for short int
    short int var2 = 1;

    // This addition will cause an overflow
    short int result_short = var1 + var2;
    auto result_auto = var1 + var2;

    std::cout << "var1: " << var1 << std::endl;  // Output: 32767
    std::cout << "var2: " << var2 << std::endl;  // Output: 1
    std::cout << "result_short: " << result_short << std::endl;  // Output: -32768 (unexpected result due to overflow)
    std::cout << "result_auto: " << result_auto << std::endl;  // Output: -32768 (unexpected result due to overflow)
